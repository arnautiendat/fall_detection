...
eng_feat_directory = config['paths_sisfall']['eng_feat_directory']
...
def compute_trial_file(trial_file_name):
    ...
    df_Features.to_csv(eng_feat_directory + 'Unified_Uci.txt', mode='a', header=False)
...
#        continue
    if(row['File'] == '.DS_Store'):
        continue
    print("_________ PROCESSING TRIAL FILE: " + row['Dirs'] + " ___________________________")
